...
public final class OrderedQtyC<caret>ursor extends MaterializedViewCursor implements Iterable<OrderedQtyCursor> {
    private static final String GRAIN_NAME = "demo";

    private static final String OBJECT_NAME = "OrderedQty";

    public final OrderedQtyCursor.Columns COLUMNS;
    ...
    {
        this.COLUMNS = new OrderedQtyCursor.Columns(callContext().getCelesta());
    }

    public OrderedQtyCursor(CallContext context) {
        super(context);
    }

    public OrderedQtyCursor(CallContext context, ColumnMeta<?>... columns) {
        super(context, columns);
    }

    @Deprecated
    public OrderedQtyCursor(CallContext context, Set<String> fields) {
    ...
    @Override
    public OrderedQtyCursor _getBufferCopy(CallContext context, List<String> fields) {
        final OrderedQtyCursor result;
        if (Objects.isNull(fields)) {
            result = new OrderedQtyCursor(context);
        }
        else {
            result = new OrderedQtyCursor(context, new LinkedHashSet<>(fields));
        }
    ...
    public void copyFieldsFrom(BasicCursor c) {
        OrderedQtyCursor from = (OrderedQtyCursor)c;
    ...
    @Override
    public Iterator<OrderedQtyCursor> iterator() {
        return new CursorIterator<OrderedQtyCursor>(this);
    }
